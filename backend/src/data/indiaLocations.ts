...
export const INDIA_STATES_AND_DISTRICTS: StateDistrictMap = {
...
export const ALL_INDIAN_STATES_AND_UTS: string[] = Object.keys(INDIA_STATES_AND_DISTRICTS).sort()
...
export function isValidState(stateName: string): boolean {
  return Boolean(stateName && INDIA_STATES_AND_DISTRICTS[stateName])
}

export function isValidDistrictForState(stateName: string, districtName: string): boolean {
  if (!isValidState(stateName) || !districtName) return false
