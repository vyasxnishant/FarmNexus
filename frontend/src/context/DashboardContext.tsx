...
export function DashboardProvider({ children }: { children: ReactNode }) {
  ...
  const addLot = async (lotData: Omit<CropLot, 'id' | 'createdAt' | 'matchedBuyersCount' | 'activeOffersCount'>): Promise<string> => {
    const res = await lotApi.create({
      ...
      initial_quantity_qtl: lotData.initialQuantityQtl || lotData.quantityQtl,
      unit: lotData.unit,
      grade: lotData.grade,
      ...
      state: lotData.state,
      district: lotData.district,
      harvest_date: lotData.harvestDate,
      available_from: lotData.availableFrom,
      available_until: lotData.availableUntil,
      description: lotData.description,
      image_url: lotData.imageUrl,
      certificate_url: lotData.certificateUrl,
      ...
      quality: {
        ...
        damaged_grain_percent: lotData.damagedGrainPercent,
...
function mapBackendLot(l: any): CropLot {
  return {
    ...
    crop: l.crop,
    cropHi: l.crop_hi,
    category: l.category || 'Grains & Cereals',
    variety: l.variety || 'Standard FAQ',
    quantityQtl: Number(l.quantity_qtl) >= 0 ? Number(l.quantity_qtl) : 0,
    ...
    moisturePercent: l.quality?.moisture_percent !== undefined ? Number(l.quality.moisture_percent) : undefined,
    foreignMatterPercent: l.quality?.foreign_matter_percent !== undefined ? Number(l.quality.foreign_matter_percent) : undefined,
    damagedGrainPercent: l.quality?.damaged_grain_percent !== undefined ? Number(l.quality.damaged_grain_percent) : undefined,
    qualityNotes: l.quality?.notes || undefined,
    description: l.description || undefined,
    imageUrl: l.image_url || l.imageUrl || undefined,
    certificateUrl: l.certificate_url || l.certificateUrl || undefined,
    ...
    harvestDate: l.harvest_date || '2026',
    availableFrom: l.available_from || undefined,
    availableUntil: l.available_until || undefined,
